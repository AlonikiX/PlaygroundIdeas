//
//  ProjectEditingViewController.m
//  Playground Ideas
//
//  Created by 孙士博 on 2017/10/19.
//  Copyright © 2017年 PlaygroundIdeasQuoll. All rights reserved.
//

#import "ProjectEditingViewController.h"

@interface ProjectEditingViewController ()<UIPickerViewDataSource,UIPickerViewDelegate, UIImagePickerControllerDelegate, UINavigationControllerDelegate,UIActionSheetDelegate>{
    NSArray *countries;
    UIImageView *showimg;
}
...
@implementation ProjectEditingViewController
...
- (void)viewDidLoad {
    ...
    [titletext setText:_projectName];
    ...
    [projectdes setText:_projectDescription];
    ...
    [draft setTitle:@"SAVE & SUBMIT" forState:UIControlStateNormal];
    ...
    [draft addTarget:self action:@selector(submit) forControlEvents:UIControlEventTouchUpInside];
